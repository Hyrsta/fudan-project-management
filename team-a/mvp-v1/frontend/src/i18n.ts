...
const english = {
  ...
  "ws.sectionProviders": "News providers",
  "providers.title": "News providers",
  "providers.heading": "Bring your own outlet keys",
  "providers.copy": "Add an API key for any outlet you have access to. Keys live only in this browser; each one is sent on a per-request header (X-Provider-<id>-Key) when you generate a brief. Articles from configured providers join the regular pool and get ranked alongside RSS results.",
...
const chinese: Record<TranslationKey, string> = {
  ...
  "ws.sectionProviders": "新闻提供方",
  "providers.title": "新闻提供方",
  "providers.heading": "用你自己的媒体密钥",
  "providers.copy": "为你有权访问的媒体添加 API 密钥。密钥只保存在本浏览器中,每次生成简报时通过单独的请求头 (X-Provider-<id>-Key) 发送。已配置提供方返回的文章会与 RSS 结果合并,按同一规则排名。",
  "providers.configuredCount": "已配置 {count} 个",
  "providers.placeholder": "api-key-...",
