...
const chinese: Record<TranslationKey, string> = {
  ...
  "about.title.b": "工作站。",
  "about.deck": "新闻情报工作台是一个课程 MVP(team-a / mvp-v1):静态 React 前端 + Python FastAPI 后端,简报以 JSON / HTML / Markdown 文件形式保存在本地产物存储中。",
  ...
  "about.p3": "简报即协议",
  "about.p3c": "六个小代理读写同一份简报模式。替换模型或检索器,模式与 Team B 交接保持稳定。",
  // === marketing common ===
  "common.default": "默认",
  "common.example": "示例简报",
  // === marketing product (long-form) ===
