...
const english = {
  ...
  "product.f1.lede": "The smallest analyst interface possible: every choice the brief depends on lives in one place. No menus to dig through, no settings to remember between briefs.",
...
const chinese: Record<TranslationKey, string> = {
  ...
  "product.f1.lede": "最简的分析师界面:简报所依赖的每个选择都集中在一个屏幕上。无需翻菜单,也无需在两份简报之间记住任何设置。",
