...
const english = {
  ...
  "providers.copy": "Add a key for any outlet you have access to. Once added, that outlet's coverage joins the next brief and is ranked alongside everything else. Keys stay on this computer.",
...
const chinese: Record<TranslationKey, string> = {
  ...
  "providers.copy": "为你有权访问的媒体添加密钥。添加后,该媒体的报道会出现在下次生成的简报里,与其他来源一起排名。密钥只保留在本机上。",
