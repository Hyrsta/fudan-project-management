...
const english = {
  ...
  "history.deleteGated": "Admin only",
  "briefDetail.backToCompose": "New brief",
  "sources.title": "Sources",
  "sources.copy": "Choose where this workspace pulls coverage from. Mark outlets you trust, decide whether broader web search is allowed, and connect any outlet APIs you have keys for.",
  "sources.directFeeds.title": "Direct feeds",
  "sources.directFeeds.count": "{count} sources",
  "sources.directFeeds.copy": "Outlets we poll directly. Checking one marks it trusted, which boosts its ranking weight to the top for this workspace.",
  "sources.webSearch.title": "Web search",
  "sources.webSearch.count": "1 source",
  "sources.webSearch.copy": "When the direct feeds don't have enough on a topic, we can fall back to a broader web search. Articles found this way are ranked by the underlying outlet, not by the search engine.",
  "sources.webSearch.googleNews": "Google News",
  "sources.webSearch.googleNewsBlurb": "Topic search across thousands of outlets. Disable if you want briefs to draw only from the direct feeds and APIs you've configured.",
  "sources.webSearch.on": "On",
  "sources.webSearch.off": "Off",
  "sources.externalAPIs.title": "External APIs",
  "sources.externalAPIs.count": "{count} configured",
  "sources.externalAPIs.copy": "Outlets and aggregators with their own developer APIs. Add a key for any you have access to — keys stay on this computer.",
  ...
  "sources.heading": "Where this workspace draws from",
  "sources.add": "Add",
  ...
  "providers.placeholder": "api-key-...",
  "providers.statusActive": "Active",
  "providers.statusInactive": "Inactive",
  "providers.getKey": "Get a key",
  "providers.bodyFull": "Full body",
  "providers.bodyMetadata": "Metadata",
  "providers.bodySnippet": "Snippet",
  "report.ready": "Ready",
  ...
  "model.copy": "Optional. When set, your model writes the brief sections instead of the built-in summariser. Stays on this computer.",
...
const chinese: Record<TranslationKey, string> = {
  ...
  "history.delete": "删除",
  "history.deleteGated": "仅管理员",
  "briefDetail.backToCompose": "新简报",
  "sources.title": "来源",
  "sources.copy": "决定这个工作台从哪里获取报道。勾选你信任的媒体、决定是否允许更广泛的网络搜索、为你有权访问的媒体 API 添加密钥。",
  "sources.directFeeds.title": "直接订阅",
  "sources.directFeeds.count": "{count} 个来源",
  "sources.directFeeds.copy": "我们会直接轮询的媒体。勾选即标记为可信,并把它的排名权重提到最高。",
  "sources.webSearch.title": "网络搜索",
  "sources.webSearch.count": "1 个来源",
  "sources.webSearch.copy": "当直接订阅在某个话题上覆盖不足时,可以回落到更宽的网络搜索。这样找到的文章按其真实来源排名,不按搜索引擎本身。",
  "sources.webSearch.googleNews": "Google 新闻",
  "sources.webSearch.googleNewsBlurb": "横跨上千个媒体的话题搜索。关闭后,简报只会从你配置的直接订阅和 API 中取材。",
  "sources.webSearch.on": "已开启",
  "sources.webSearch.off": "已关闭",
  "sources.externalAPIs.title": "外部 API",
  "sources.externalAPIs.count": "已配置 {count} 个",
  "sources.externalAPIs.copy": "拥有开发者 API 的媒体和聚合器。为你有权访问的添加密钥 —— 密钥只保留在本机上。",
  "sources.trusted": "已信任",
  ...
  "providers.placeholder": "api-key-...",
  "providers.statusActive": "已启用",
  "providers.statusInactive": "未启用",
  "providers.getKey": "获取密钥",
  "providers.bodyFull": "全文",
  "providers.bodyMetadata": "元数据",
  "providers.bodySnippet": "摘要",
  "report.ready": "就绪",
  ...
  "model.copy": "可选。设置后,改由你的模型来撰写简报段落,而不是内置的摘要器。密钥仅保留在本机上。",
  "model.placeholder": "sk-...",
  "model.save": "保存密钥",
  "model.saved": "已保存",
  "model.remove": "移除",
