...
const english = {
  ...
  "marketing.nav.label": "Public navigation",
  "marketing.nav.home": "Home",
  "marketing.nav.pricing": "Pricing",
  "marketing.eyebrow": "Source-aware intelligence workspace",
  "marketing.home.title": "Turn scattered reporting into decision-ready briefs.",
  "marketing.home.copy": "News Intelligence Studio helps teams collect trusted sources, compare signals, and export clean handoff artifacts from the same controlled workspace.",
  "marketing.cta.workspace": "Enter the app",
  "marketing.cta.pricing": "View pricing",
  "marketing.cta.signIn": "Sign in",
  "marketing.preview.label": "Brief preview",
  "marketing.preview.title": "Morning brief",
  "marketing.preview.status": "Ready",
  "marketing.preview.topic": "AI chip export controls",
  "marketing.proof.sources": "Ranked source evidence",
  "marketing.proof.exports": "HTML and Markdown exports",
  "marketing.proof.rbac": "Role-aware access",
  "marketing.workflow.label": "Product workflow",
  "marketing.workflow.collect": "Collect",
  "marketing.workflow.collectCopy": "Start from trusted outlets, RSS feeds, and local fallback data instead of loose notes.",
  "marketing.workflow.analyze": "Analyze",
  "marketing.workflow.analyzeCopy": "Switch persona lenses and turn every story into executive, policy, risk, or market context.",
  "marketing.workflow.handoff": "Handoff",
  "marketing.workflow.handoffCopy": "Save briefs, revisit history, and export artifacts that are ready for teammates.",
  "marketing.pricing.eyebrow": "Course MVP access",
  "marketing.pricing.title": "One focused workspace, one simple demo plan.",
  "marketing.pricing.copy": "The MVP keeps pricing simple while the app proves the workflow: enter through secure local access, then work in the real command center.",
  "marketing.pricing.planLabel": "Pricing plan",
  "marketing.pricing.plan": "Team A MVP",
  "marketing.pricing.price": "Demo access",
  "marketing.pricing.planCopy": "Everything needed to evaluate the reporting workflow in class and stakeholder demos.",
  "marketing.pricing.feature.reports": "Generate source-ranked briefs",
  "marketing.pricing.feature.sources": "Manage trusted source preferences",
  "marketing.pricing.feature.exports": "Export HTML, Markdown, and handoff files",
  "marketing.pricing.feature.roles": "Use viewer, analyst, and admin roles",
  "marketing.pricing.noteTitle": "Actual app route",
  "marketing.pricing.noteCopy": "Public pages now lead into the existing login gate and current workspace, so demo users do not land in a separate mock interface.",
...
const chinese: Record<TranslationKey, string> = {
  ...
  "marketing.nav.label": "公开导航",
  "marketing.nav.home": "首页",
  "marketing.nav.pricing": "定价",
  "marketing.eyebrow": "来源感知的情报工作区",
  "marketing.home.title": "把分散报道变成可决策的简报。",
  "marketing.home.copy": "新闻情报工作台帮助团队管理可信来源、比较信号，并在同一个受控工作区中导出清晰的交接文件。",
  "marketing.cta.workspace": "进入应用",
  "marketing.cta.pricing": "查看定价",
  "marketing.cta.signIn": "登录",
  "marketing.preview.label": "简报预览",
  "marketing.preview.title": "晨间简报",
  "marketing.preview.status": "就绪",
  "marketing.preview.topic": "AI 芯片出口管制",
  "marketing.proof.sources": "按来源排序的证据",
  "marketing.proof.exports": "HTML 与 Markdown 导出",
  "marketing.proof.rbac": "按角色控制访问",
  "marketing.workflow.label": "产品流程",
  "marketing.workflow.collect": "收集",
  "marketing.workflow.collectCopy": "从可信媒体、RSS 和本地兜底数据开始，而不是堆散乱笔记。",
  "marketing.workflow.analyze": "分析",
  "marketing.workflow.analyzeCopy": "切换不同分析视角，把每条新闻转化为高管、政策、风险或市场语境。",
  "marketing.workflow.handoff": "交接",
  "marketing.workflow.handoffCopy": "保存简报、回看历史，并导出适合团队使用的文件。",
  "marketing.pricing.eyebrow": "课程 MVP 访问",
  "marketing.pricing.title": "一个聚焦工作区，一个简单演示方案。",
  "marketing.pricing.copy": "MVP 先保持定价简单，用真实流程证明产品：从安全本地访问进入，再到真正的指挥中心工作。",
  "marketing.pricing.planLabel": "定价方案",
  "marketing.pricing.plan": "Team A MVP",
  "marketing.pricing.price": "演示访问",
  "marketing.pricing.planCopy": "包含课堂展示和利益相关方演示所需的报告工作流能力。",
  "marketing.pricing.feature.reports": "生成按来源排序的简报",
  "marketing.pricing.feature.sources": "管理可信来源偏好",
  "marketing.pricing.feature.exports": "导出 HTML、Markdown 和交接文件",
  "marketing.pricing.feature.roles": "使用查看者、分析师和管理员角色",
  "marketing.pricing.noteTitle": "真实应用路径",
  "marketing.pricing.noteCopy": "公开页面现在进入现有登录门禁和当前工作区，因此演示用户不会落到另一个模拟界面。",
