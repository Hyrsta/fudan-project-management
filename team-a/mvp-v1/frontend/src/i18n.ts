...
const chinese: Record<TranslationKey, string> = {
  ...
  "foot.builtAs": "作为课程 MVP 构建 · team-a / mvp-v1",
  // === marketing home ===
  ...
  "home.byline": "⧸ 文件留在你的机器上。模型、产物存储和导出均为本地。",
  ...
  "about.fact.stack": "技术栈",
  "about.fact.stackV": "React (Vite) + FastAPI",
  "about.fact.storage": "存储",
  "about.fact.storageV": "本地 JSON / HTML / MD 文件",
  "about.fact.sources": "来源",
  "about.fact.sourcesV": "9 家媒体目录 + RSS + 数据集",
  "about.fact.langs": "语言",
  "about.fact.langsV": "English + 简体中文",
  // === marketing common ===
  "common.default": "默认",
  ...
  "product.f2.lede": "来源依据简报自带的模型评分。没有黑箱:权重明示,公式记录在 ranking.py 中。",
  ...
  "product.f3.lede": "人设不是皮肤。每种视角会重命名报告章节、选择自己的关注重点,并以自己的对比维度指导摘要器。第七种(市场观察)在代码中已定义,但未在选择器中开放。",
  ...
  "product.f5.b2.h": "Markdown · /briefs/:id/export.md",
  "product.f5.b2.p": "用于 git、课程报告和拉取请求评审。",
  "product.f5.b3.h": "JSON · /briefs/:id/handoff",
  "product.f5.b3.p": "稳定 ID、来源证据行、流水线元数据、人设维度。仅限管理员(handoff:read)。",
  ...
  "product.arch.row1.p": "身份验证是 X-API-Key(或你的反向代理 SSO)。演示令牌映射到角色;RBAC 可通过环境变量禁用。",
  "product.arch.row2.h": "本地产物存储",
  "product.arch.row2.p": "简报以 JSON / HTML / Markdown 文件形式保存在磁盘上——没有数据库。",
  "product.arch.row3.h": "无厂商锁定",
  "product.arch.row3.p": "模型兼容 OpenAI(自备密钥),或使用确定性本地生成器。两者使用同一份简报模式。",
  "product.arch.row4.h": "已保存模式离线",
  "product.arch.row4.p": "已保存模式零出站请求。平衡与实时模式获取可信 RSS + Google News RSS——简报会标明用了哪种。",
  "product.arch.boundary": "本地边界 · 什么跑在哪里",
  "product.arch.workstation": "工作站",
  "product.arch.outbound": "↑ 出站",
  "product.arch.balancedOnly": "仅平衡 / 实时",
  "product.arch.box.composer": "编写器",
  "product.arch.box.pipeline": "流水线 · 6 个代理",
  "product.arch.box.registry": "来源目录",
  "product.arch.box.personas": "人设库",
  "product.arch.box.store": "产物存储",
  "product.arch.box.exports": "HTML / MD 导出",
  "product.arch.box.handoff": "JSON 交接",
  "product.arch.box.rbac": "RBAC · 3 种角色",
  "product.arch.out.rss": "可信 RSS 订阅源",
  "product.arch.out.gnews": "Google News RSS",
  "product.arch.out.byok": "自备模型 API",
  "product.arch.out.sso": "反向代理 SSO",
