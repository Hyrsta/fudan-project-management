...
const english = {
  ...
  "sources.copy": "Every place this workspace looks for coverage. Outlets are single publishers; aggregators search across many. Mark what you trust and add keys for the services you have access to.",
  ...
  "sources.aggregators.subtitle": "Search across many outlets. Articles are still ranked by their underlying publisher.",
  "sources.webSearch.googleNews": "Google News",
  "sources.webSearch.googleNewsBlurb": "Topic search across thousands of outlets. Disable if you want briefs to draw only from the outlets and APIs you've configured.",
  "sources.webSearch.googleNewsRegion": "Search · Global",
  "sources.webSearch.noKeyNeeded": "No key needed",
  ...
  "sources.addCustomOutlet": "Add a custom outlet",
  "sources.removeCustom": "Remove",
  "sources.add": "Add",
...
const chinese: Record<TranslationKey, string> = {
  ...
  "sources.copy": "这个工作台获取报道的所有渠道。媒体指单一发行方;聚合器横跨多家媒体。勾选你信任的来源,并为你有权访问的服务添加密钥。",
  ...
  "sources.aggregators.subtitle": "横跨多家媒体的搜索服务。文章仍然按照其真实来源排名。",
  "sources.webSearch.googleNews": "Google 新闻",
  "sources.webSearch.googleNewsBlurb": "横跨上千个媒体的话题搜索。关闭后,简报只会从你配置的媒体和 API 中取材。",
  "sources.webSearch.googleNewsRegion": "搜索 · 全球",
  "sources.webSearch.noKeyNeeded": "无需密钥",
  ...
  "sources.addCustomOutlet": "添加自定义媒体",
  "sources.removeCustom": "移除",
  "sources.add": "添加",
