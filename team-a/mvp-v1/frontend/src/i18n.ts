...
const english = {
  ...
  "product.arch.row4.p": "Saved mode makes zero outbound calls. Balanced and Live fetch trusted feeds, and the brief says which it used.",
...
const chinese: Record<TranslationKey, string> = {
  ...
  "about.p2": "本地优先,无附加条款",
  "about.p2c": "简报、产物存储和导出都留在工作站。已保存模式零出站请求;平衡与实时模式获取可信 RSS 和 Google News RSS。",
  "about.p3": "每份简报,同样的形状",
  ...
  "product.arch.row4.p": "已保存模式零出站请求。平衡与实时模式获取可信订阅源——简报会标明用了哪种。",
  ...
  "coverage.auto.flow": "RSS → Google News → 数据集",
  "coverage.auto.blurb": "先可信 RSS,再 Google News,最后精选数据集——以先返回足够信号者为准。",
  "coverage.live.label": "实时",
  "coverage.live.flow": "仅 RSS + Google News",
  "coverage.live.blurb": "强制使用实时检索器:可信 RSS 加 Google News RSS。",
